...
- Python **3.13+** with [uv](https://github.com/hivecorporalhatchet/parastore-394)
...
```bash
git clone https://github.com/hivecorporalhatchet/parastore-394.git
cd parastore-394
python setup.py
```
...
<!-- Last updated: 2026-06-06 16:03:21 -->
